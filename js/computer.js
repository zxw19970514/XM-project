...
class Computer{
    ...
    insert(){
        var that=this;
        $.ajax({
            url:"http://127.0.0.1/XM-project/data/secondli.json",
    ...
    display(){
        ...
        str=`<div class="mc_c mc_c_computer">
            ...
            <div class="mc_r">
                ...
                <a href="#" class="mc_r_img"><img a-arc="${this.res[0].img9}" alt=""></a>
            </div>`
        $('.spe_li_computer').html(str);
    }
}
