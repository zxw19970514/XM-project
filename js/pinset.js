...
class Pinsert{
    ...
    insert(){
        var that=this;
        $.ajax({
            url:"http://127.0.0.1/XM-project/data/phonegood.json",
            success:function(res){
                that.res=res;
                that.display();
                $('.mc_c_phone').terseBanner({
                    arrow:true,
                })
            }
        })
